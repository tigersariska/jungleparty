...
class Mage_Sales_Model_Order extends Mage_Sales_Model_Abstract
{
    ...
    {
       // echo "<pre>".print_r($this->getPaymentsCollection(), true)."</pre>";
        //die();
        ...
        return Mage_Payment_Model_Info::getMethodInstance();
    }
    ...
    {
        //echo "STATE: ".print_r($state, true)." | status = ".print_r($state, true)." cOMMENT: ".$comment;
    ...
    public function sendNewOrderEmail()
    {
       ...
       try {
            ...
            //echo "GET PAYMENT METHOD: ".print_r($this->getPayment(), true);
           // die();
...
/*********************** PAYMENTS ***************************/
    ...
    public function getPaymentsCollection()
    {
        if (is_null($this->_payments)) {
            //echo "this->_payment is null";
            $this->_payments = Mage::getResourceModel('sales/order_payment_collection')
               ->addAttributeToSelect('*')
                ->setOrderFilter($this);
            //echo "something in this payment".print_r($this->_payments, true);
